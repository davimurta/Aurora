  ...
  const loadPDF = async () => {
    try {
      if (Platform.OS === 'web') {
        ...
        setPdfUri(require('../../../../assets/Termo_de_Uso_Aurora_Formatado_Completo.pdf'));
        setIsLoading(false);
      } else {
        // Para mobile, copie o PDF para o cache e use o URI local
        const asset = require('../../../../assets/Termo_de_Uso_Aurora_Formatado_Completo.pdf');
        const fileUri = `${FileSystem.cacheDirectory}Termo_de_Uso_Aurora.pdf`;
  ...
  const handleOpenPDF = async () => {
    try {
      if (Platform.OS === 'web') {
        ...
        window.open(require('../../../../assets/Termo_de_Uso_Aurora_Formatado_Completo.pdf'), '_blank');
      } else {
        ...
        if (fileInfo.exists) {
          ...
          if (canShare) {
            await Sharing.shareAsync(fileUri, {
              ...
              dialogTitle: 'Abrir Termo de Uso',
              UTI: 'com.adobe.pdf',
            });
          } else {
